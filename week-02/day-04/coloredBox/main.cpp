...
void draw()
{
    ...
    SDL_RenderDrawLine(gRenderer, 200, 200, 400, 200);
    SDL_SetRenderDrawColor(gRenderer, 0, 0, 255, 0xFF);
    SDL_RenderDrawLine(gRenderer, 400, 200, 400, 300);
    SDL_SetRenderDrawColor(gRenderer, 0, 255, 0, 0xFF);
    SDL_RenderDrawLine(gRenderer, 400, 300, 200, 300);
    SDL_SetRenderDrawColor(gRenderer, 0xFF, 0x00, 0x00, 0xFF);
    SDL_RenderDrawLine(gRenderer, 200, 300, 200, 200);
    //create a rectangle
