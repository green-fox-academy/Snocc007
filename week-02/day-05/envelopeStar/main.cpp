...
void draw()
{
 ...
 /*   for (int i = 1; i <= 20; i++) {
        ...
        SDL_SetRenderDrawColor(gRenderer, 255, 255, 0, 0xFF);
        SDL_RenderDrawLine(gRenderer, SCREEN_WIDTH - SCREEN_WIDTH, SCREEN_HEIGHT - SCREEN_HEIGHT / 20 * (20 - i),
                           SCREEN_WIDTH / 20 * i, SCREEN_HEIGHT);

        SDL_SetRenderDrawColor(gRenderer, 0, 255, 0, 0xFF);
        SDL_RenderDrawLine(gRenderer, SCREEN_WIDTH - SCREEN_WIDTH / 20 * i, SCREEN_HEIGHT - SCREEN_HEIGHT, SCREEN_WIDTH,
                           SCREEN_HEIGHT - SCREEN_HEIGHT / 20 * i);
    } */
};
