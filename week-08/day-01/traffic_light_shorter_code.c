...
int main(void)
{
	...
	while (1) {
		...
		tim_val = __HAL_TIM_GET_COUNTER(&TimHandle);
			...
			HAL_GPIO_WritePin(GPIOF, GPIO_PIN_8, tim_val < 10000);
			HAL_GPIO_WritePin(GPIOF, GPIO_PIN_9, 10000 <= tim_val && tim_val < 12000 || tim_val >= 22000);
			HAL_GPIO_WritePin(GPIOF, GPIO_PIN_10, 12000 <= tim_val);
